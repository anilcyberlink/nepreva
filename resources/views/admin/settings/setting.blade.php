            ...
            <div class="panel">
              ...
              <div class="panel-body"> 
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-lg-3 control-label" for="textArea2">Frontpage Text For Service</label>
                    <div class="col-lg-9">
                      <div class="bs-component">
                  ...
                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="textArea2">Frontpage Text For Blog </label>
                    <div class="col-lg-9">
                      <div class="bs-component">
                        <textarea class="form-control" id="" name="title1" rows="3">{{$data->title1}}</textarea>
                      </div>
                    </div>
                  </div>  
                  <div class="form-group">
                    <label class="col-lg-3 control-label" for="textArea2">Frontpage Text For Gallery </label>
                    <div class="col-lg-9">
                      <div class="bs-component">
                        <textarea class="form-control" id="" name="title2" rows="3">{{$data->title2}}</textarea>
                      </div>
                    </div>
                  </div>  
        ...
        <div class="admin-form">
          ...
          <h4> You Tube</h4>                   
           ...
           <div class="sid_ mb10"> 
            <h4> Experience </h4>                   
           <div class="bs-component">
              <input type="number" id="" name="experience" class="form-control" placeholder="" value="{{$data->experience}}" />
            </div>          
           </div>

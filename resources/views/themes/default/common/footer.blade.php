                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6">
                                <div class="footer-wrapper mb-30">
                                    <div class="footer-logo">
                                         <a href="{{ url('/')}}"><img src="{{ asset('themes-assets/img/Neprivabglogo.png') }}" alt=""></a>
                                ...
                                <div class="footer-wrapper mb-30">
                                    ...
                                    <div class="recent-news">
                                        <div class="recent-news-text">
                                            ...
                                            <div class="news-date">
                                                <span><i class="far fa-calendar-alt"></i> 1 Jan 2026</span>
                                            </div>
                                        </div>
                                        <div class="recent-news-text">
                                            <h4><a href="#">Monthly Web Develop Update Modern Techniques.</a></h4>
                                            <div class="news-date">
                                                <span><i class="far fa-calendar-alt"></i> 10 Jan 2026</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
